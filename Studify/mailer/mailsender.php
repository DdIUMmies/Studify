...
function send_mail($email, $oggetto="Newsletter", $messaggio="Ciao", $path_allegato = null){
        $mail = new PHPMailer();
        $mail->IsSMTP();
        ...
        $mail->Username = "alessandro.dipatria@gmail.com"; //la vostra mail
        $mail->Password = "105178gla"; //password per accedere alla vostra mail
        $mail->Priority    = 1; //(1 = High, 3 = Normal, 5 = low)
        $mail->setFrom('alessandro.dipatria@gmail.com', 'Alessandro'); //impostazione del mittente
